...
@Component({
  selector: 'page-steak-eggs',
  templateUrl: 'steak-eggs.html'
})
export class SteakEggsPage {
  cartItem : Cart;
  
  value: number = 1; 
    constructor(public navCtrl: NavController, public cartService : CartService) {
   
      this.cartItem = new Cart("assets/img/steak n eggs.png", "Steak & Eggs", "Signature", 48.00, 0);
